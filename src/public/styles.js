...
.input_send{display:block;padding-left:10px;cursor:default}
.input_send.active{cursor:pointer}

.action_container{display:flex;justify-content:flex-end}
.action_button{display:flex;text-align:center;border-radius:10px;padding:12px;margin-left:10px;margin-bottom:10px;cursor:default;outline:0 solid;border:0;box-shadow:0 5px 5px rgba(0,0,0,0.1);white-space:nowrap;overflow:hidden;justify-content:center;align-items:center}
